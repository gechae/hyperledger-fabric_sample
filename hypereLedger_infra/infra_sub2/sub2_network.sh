...
function printHelp() {
    ...
    # echo "  sub2_network.sh -install channel1 test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub2_network.sh -install channel1 test-cc 3.2.11 <install to specific version>"
    # echo "  sub2_network.sh -install channel1 test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub2_network.sh -install channel1 test-cc 3.2.11 <install to specific version>"
    echo
    echo "upgrade example"
    # echo "  sub2_network.sh -install channel1 test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub2_network.sh -upgrade channel1 test-cc 3.2.11 <upgrade to specific version>"
    # echo "  sub2_network.sh -install channel1 test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub2_network.sh -upgrade channel1 test-cc 3.2.11 <upgrade to specific version>"
    echo
    echo "============"
