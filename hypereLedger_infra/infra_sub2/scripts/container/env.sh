...
function initOrgVars() {
    ...
    ROOT_CA_CERTFILE=/crypto-config/ca-certs/ca.org${ORG}.bminjabc.ex.co.kr-cert.pem
    ORG_MSP_ID=${ORG}MSP
    ...
    CA_HOST_PORT=ca.org${ORG}.bminjabc.ex.co.kr:${PORT}
...
function initPeerVars() {
    ...
    CA_HOST_PORT=ca.org${ORG}.bminjabc.ex.co.kr:${PORT}
    #CA_HOST_PORT=ca.orgswt.com:${PORT}
    PEER_HOST=peer${NUM}.org${ORG}.bminjabc.ex.co.kr
    PEER_NAME=peer${NUM}.org${ORG}.bminjabc.ex.co.kr
