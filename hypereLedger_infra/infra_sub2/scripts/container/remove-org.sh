...
peer channel fetch config /opt/gopath/src/github.com/hyperledger/fabric/peer/remove_config/config_block.pb -o orderer0.orgorderer.ex.co.kr:9060 -c $CHANNEL_NAME --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/orgorderer.ex.co.kr/msp/tlscacerts/ca-orgorderer-ex-co-kr-9080.pem
