...
docker exec $ENV_STR_PEER0 cli peer chaincode instantiate -o $ORDERER_ADDRESS0 -C $CHANNEL_NAME -n $CHAINCODE_NAME -l golang -v $CHAINCODE_VERSION -c '{"Args":["Init"]}' --tls true --cafile $CA_FILE
