...
peer channel fetch config /opt/gopath/src/github.com/hyperledger/fabric/peer/remove_config/config_block.pb -o orderer1.orgorderer.com:9060 -c $CHANNEL_NAME --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/orgorderer.com/msp/tlscacerts/ca-orgorderer-bbc-ex-co-kr-9080.pem
