...
function initOrgVars() {
    ...
    ROOT_CA_CERTFILE=/crypto-config/ca-certs/ca.org${ORG}.bbc.ex.co.kr-cert.pem
    ORG_MSP_ID=${ORG}MSP
    ORG_MSP_DIR=/root/orgs/${ORG}/msp
    echo "###################### ORG_MSP_DIR ${ORG_MSP_DIR}"
    ...
    #CA_HOST_PORT=ca.orgswt.com:${PORT}
    CA_HOST_PORT=ca.org${ORG}.bbc.ex.co.kr:${PORT}
...
function initOrdererVars() {
    ...
    NUM=$2
    CA_HOST_PORT=ca.org${ORG}.bbc.ex.co.kr:${PORT}
    ORDERER_HOST=orderer${NUM}.org${ORG}.ex.co.kr
    ORDERER_NAME=orderer${NUM}.org${ORG}.ex.co.kr
...
function initPeerVars() {
    ...
    CA_HOST_PORT=ca.org${ORG}.bbc.ex.co.kr:${PORT}
    #CA_HOST_PORT=ca.orgswt.com:${PORT}
    PEER_HOST=peer${NUM}.org${ORG}.bbc.ex.co.kr
    PEER_NAME=peer${NUM}.org${ORG}.bbc.ex.co.kr
