...
function printHelp() {
    ...
    # echo "  sub1_network.sh -install cert-channel test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub1_network.sh -install cert-channel test-cc 3.2.11 <install to specific version>"
    # echo "  sub1_network.sh -install tsa-channel test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub1_network.sh -install tsa-channel test-cc 3.2.11 <install to specific version>"
    echo
    echo "upgrade example"
    # echo "  sub1_network.sh -install cert-channel test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub1_network.sh -upgrade cert-channel test-cc 3.2.11 <upgrade to specific version>"
    # echo "  sub1_network.sh -install tsa-channel test-cc <upgrade to the next version ex) 1.0.00 > 2.0.0>"
    echo "  sub1_network.sh -upgrade tsa-channel test-cc 3.2.11 <upgrade to specific version>"
    echo
    echo "============"
    echo "   NOTICE   "
    echo "============"
