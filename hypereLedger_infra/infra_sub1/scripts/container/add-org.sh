...
peer channel fetch config /opt/gopath/src/github.com/hyperledger/fabric/peer/add_config/config_block.pb -o orderer0.orgorderer.com:7050 -c $CHANNEL_NAME --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/orgorderer.com/msp/tlscacerts/ca-orgorderer-com-8054.pem
...
peer channel update -f /opt/gopath/src/github.com/hyperledger/fabric/peer/add_config/config_update_in_envelope.pb -o orderer0.orgorderer.com:7050 -c $CHANNEL_NAME --tls true --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/orgorderer.com/msp/tlscacerts/ca-orgorderer-com-8054.pem
